...
module Mypackage
  module Enquete
    ...
    Question = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("mypackage.enquete.Question").msgclass
    Question::Format = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("mypackage.enquete.Question.Format").enummodule
    Option = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("mypackage.enquete.Option").msgclass
